...
- Smarter reordering in Purchases (the surviving, workflow-fitting piece of the inventory exploration): one-click "buy again" from history, a shared "to reorder" capture from anywhere that flows into the needs-ordering queue, and an optional reorder nudge computed from your own purchase cadence. No new logging step.
