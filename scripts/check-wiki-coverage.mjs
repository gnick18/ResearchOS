...
const EXCLUDED_PREFIXES = [
  ...
  "/figures", // pending wiki page (Universal Figure Composer; live AppShell route, wiki page + APP_ROUTE_TO_WIKI entry land with the figure-composer lane's docs). Like /phylo.
