...
MILESTONES = [
    # Ordered by the first commit in each feature bucket (commit-map.json).
    # Patterns are the fallback used only when commit-map.json is absent; bar
    # lengths otherwise come from the AI-classified per-feature counts.
