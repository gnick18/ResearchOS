// Content-anchor helpers for phone-note placement (P2, mobile side).
//
...
// "insert my note AFTER the block with anchor X"; the laptop uses the byte
...
//
// MUST stay byte-identical with the other copy in
// frontend/src/lib/mobile-relay/note-anchor.ts. If you change one, change both.
//
