...
**Room capture**
- **Apple RoomPlan** is the single best 3D lever: parametric (labeled, dimensioned) USDZ output, ~cm accuracy, multi-room via StructureBuilder, and a usable **Expo wrapper already exists** (`expo-roomplan`, community-maintained — vet it). BUT it is **LiDAR-only, and LiDAR is a Pro-exclusive sensor**: every **Pro / Pro Max since the iPhone 12 Pro** has it (12/13/14/15/16/17 Pro and Pro Max, confirmed mid-2026), plus LiDAR iPad Pros. **No standard / Plus / mini / SE / 17e model has ever shipped LiDAR** — so a brand-new regular iPhone 17 cannot run RoomPlan while a 2020 iPhone 12 Pro can. The dividing line is **Pro vs non-Pro, not new vs old**; UI copy must say "needs an iPhone/iPad **Pro**," not "a recent iPhone." iOS 16+ (17+ for multi-room).
