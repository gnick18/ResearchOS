...
- Item 1 (precise per-OWNER activity throttle) still DEFERRED to billing-go-live: the per-doc throttle + global breaker bound activity for the flip; a precise per-owner activity rollup is a billing-accuracy concern, not a catastrophic-loss one.
