  ...
  return (
    ...
    >
      ...
      <p>
        ...
        is not enough — ResearchOS needs the desktop app, because that&apos;s
        what creates the local filesystem folder you point ResearchOS at.
      </p>
      ...
      <Callout variant="tip" title="Switching modes later">
        ...
        everything to your disk over the next few minutes / hours depending on
        size. Or, per-folder: right-click the lab folder → <strong>Make
        available offline</strong>.
      </Callout>
      ...
      <Steps>
        ...
        <Step>
          ...
          is fully downloaded — no cloud icon next to file names.
        </Step>
        <Step>
      ...
      <ul>
        <li>
          <strong>Windows</strong> — usually mounted as drive{" "}
          <code>G:</code> or under <code>%USERPROFILE%\GoogleDrive</code>.
        </li>
        <li>
          <strong>macOS</strong> — under <code>~/Library/CloudStorage/GoogleDrive-&lt;you@…&gt;/</code>{" "}
          or shown as a volume on the desktop.
        </li>
      </ul>
