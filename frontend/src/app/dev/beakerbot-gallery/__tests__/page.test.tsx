...
//   - the dropdown lists all 21 poses + 8 scenes + 3 pose-celebration
//     variants = 32 entries total
...
describe("BeakerBotGalleryPage", () => {
  ...
  it("exports a catalog of 32 entries: 21 poses + 8 scenes + 3 pose-celebrations", () => {
    ...
    expect(BEAKERBOT_ANIMATION_CATALOG).toHaveLength(32);
  });

  it("dropdown lists all 32 catalog entries", () => {
    render(<BeakerBotGalleryPage />);
