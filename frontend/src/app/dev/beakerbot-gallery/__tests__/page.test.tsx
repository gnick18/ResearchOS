...
//   - the dropdown lists all 18 poses + 9 scenes + 3 pose-celebration
//     variants = 30 entries total (PipetteAim added)
...
describe("BeakerBotGalleryPage", () => {
  ...
  it("exports a catalog of 30 entries: 18 poses + 9 scenes + 3 pose-celebrations", () => {
    ...
    expect(BEAKERBOT_ANIMATION_CATALOG).toHaveLength(30);
  });

  it("dropdown lists all 30 catalog entries", () => {
    render(<BeakerBotGalleryPage />);
