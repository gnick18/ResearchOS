...
export default function GlobalDropGuard() {
  ...
  return (
    <div
      className="fixed z-[60] max-w-sm rounded-lg border border-amber-300 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/15 px-4 py-3 text-body text-amber-900 dark:text-amber-300 shadow-lg pointer-events-none"
      style={{
