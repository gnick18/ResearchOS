      ...
      >
          ...
          <button
            ...
            className={`p-2 rounded-lg transition-all ${
              task.is_complete
                ...
                : "text-foreground-muted hover:text-green-500 hover:bg-green-50"
            }`}
          >
        ...
        <Tooltip label="Open full details" placement="bottom">
          <button
            ...
            className="p-2 rounded-lg text-foreground-muted hover:text-blue-500 hover:bg-blue-50 transition-all"
          >
