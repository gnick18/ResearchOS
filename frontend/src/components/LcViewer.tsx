      ...
      <div className="flex flex-col h-full">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            ...
            <p className="text-meta text-gray-400 mt-0.5">LC Gradient</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            <p className="text-body text-gray-400 animate-pulse">Loading LC gradient…</p>
          ) : !protocol ? (
            <div className="text-center py-8">
              <p className="text-body text-gray-500">LC gradient protocol not found. It may have been deleted.</p>
            </div>
          ) : (
            <LcGradientEditor
