...
export default function CalculatorSendOutsideDialog({
  ...
  return (
    ...
    >
      <div
        className="bg-surface-overlay border border-border rounded-xl ros-popup-card-shadow max-w-md w-full mx-4 max-h-[90vh] overflow-hidden flex flex-col"
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        type="button"
        onClick={onSetUp}
        className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 w-full py-2 text-body font-medium"
      >
        Set up sharing
      </button>
    </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-2 pt-1">
          ...
          <button
            ...
            className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 flex-1 py-2 text-body font-medium"
          >
            Invite and share
          </button>
        </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-1">
        ...
        <button
          ...
          onClick={handleSend}
          disabled={!canSend}
          className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 flex-1 py-2 text-body font-medium disabled:opacity-50 disabled:cursor-not-allowed"
        >
