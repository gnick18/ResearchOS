...
function SendForm({
  ...
  // honestly, an invite sends the note's unlock key in the email link, so it is
  // a lower-assurance channel than sending to an existing account.
      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-body text-foreground-muted mt-1 leading-relaxed">
              ...
              note. They create a free account to open it, the note stays
        ...
        <div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-500/15 border border-amber-200 dark:border-amber-500/30 rounded-lg">
          ...
          <p className="text-meta text-amber-800 dark:text-amber-300 leading-relaxed">
            ...
            read that email can open the note. Only invite an address you trust.
          </p>
        </div>
