      ...
      <div className="mt-6 flex items-center justify-between gap-2">
        ...
        {step === "map" && (
          <>
            ...
            <button
              ...
              onClick={goToPreview}
              disabled={!nameMapped}
              className="btn-brand inline-flex items-center gap-1.5 rounded-lg px-4 py-2 text-body disabled:cursor-not-allowed disabled:opacity-50"
            >
              Next, preview
              <Icon name="chevronRight" className="h-4 w-4" />
            </button>
        ...
        {step === "result" && (
          <button
            type="button"
            onClick={onDone}
            className="btn-brand mx-auto inline-flex items-center gap-1.5 rounded-lg px-5 py-2 text-body"
          >
            Done
          </button>
        )}
