      ...
      <div className="absolute right-4 top-4 z-10 flex items-center gap-3 rounded-2xl border border-border bg-surface-raised/95 px-3 py-2 ros-popup-card-shadow ring-1 ring-black/5 backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={saving || !img}
            className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 px-4 py-2 text-body font-medium rounded-lg disabled:opacity-50"
          >
            {saving ? "Saving..." : "Save"}
          </button>
        </div>
