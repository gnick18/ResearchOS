        ...
        <div className="border-b border-gray-100 px-5 py-4 space-y-3">
          <div className="flex flex-wrap items-end gap-3">
            ...
            {hasSelection && (
              <button
                ...
                className="self-end rounded-md border border-gray-200 bg-white px-3 py-1.5 text-body font-medium text-gray-700 transition-colors hover:bg-gray-50"
              >
                Use selection
              </button>
            )}
          ...
          <label className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-md border border-gray-200 px-3 py-2 font-mono text-body text-gray-900 focus:border-sky-400 focus:outline-none resize-y"
            />
          </label>
          <p className="text-meta text-gray-500">
            {source === "selection"
