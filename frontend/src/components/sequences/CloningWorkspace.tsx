              ...
              {pasteOpen ? (
                <div className="mt-2 rounded-md border border-border p-3">
                  ...
                  <div className="mt-2 flex justify-end gap-2">
                    ...
                    <button type="button" onClick={addPasted} disabled={!sanitizeRawSequence(pasteSeq, "dna")} className="ros-btn-raise rounded-md bg-brand-action px-3 py-1.5 text-meta font-medium text-white hover:bg-brand-action/90 disabled:opacity-50">Add fragment</button>
                  </div>
                </div>
              ) : null}
            </div>
            ...
            <div className="border-t border-border p-4">
              ...
              >
                <button
                  ...
                  className="ros-btn-raise w-full rounded-md bg-brand-action px-3 py-2 text-body font-medium text-white hover:bg-brand-action/90 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {method === "overlap"
                    ? "Review junctions"
                    : method === "gateway"
