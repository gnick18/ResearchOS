 ...
 *  flag, and the parent re-derives the SeqViz props exactly as before. */
export default function ViewControlRail({ view, onViewChange, circular }: ViewControlRailProps) {
