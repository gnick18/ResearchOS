      ...
      <div className="w-full">
        ...
        <div className="flex items-center justify-end gap-2 border-t border-border px-5 py-3">
          ...
          <button
            ...
            className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 inline-flex items-center gap-1.5 rounded-lg px-4 py-2 text-body disabled:opacity-50 disabled:cursor-not-allowed"
          >
