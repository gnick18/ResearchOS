...
/**
 * Pre-onboarding Beat 2: Data security.
 *
 * The trust beat. This is the highest-priority panel in the entire
 * pre-onboarding arc per PRE_ONBOARDING_PROPOSAL.md §6.2 — without it,
 * fresh users assume "pick a folder" is uploading their files and
 * bounce. The copy has to land as "we genuinely cannot see your data,"
 * not as legal-flavored privacy boilerplate.
 *
...
export default function SecurityBeat({ onNext }: SecurityBeatProps) {
  return (
    <div data-testid="pre-onboarding-beat-security">
      ...
      <div className="flex justify-end">
        <button
          ...
          data-testid="pre-onboarding-security-next"
        >
          Got it, next
        </button>
      </div>
