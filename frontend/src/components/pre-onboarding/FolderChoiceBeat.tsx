...
/**
 * Pre-onboarding Beat 3: Folder choice (local vs cloud-synced).
 *
 ...
 * the API is shaped for it), they'd start fresh — we don't persist
 * across remounts.
 */
...
export default function FolderChoiceBeat({ onContinue }: FolderChoiceBeatProps) {
  ...
  return (
    <div data-testid="pre-onboarding-beat-folder-choice">
      ...
      <div className="flex justify-end">
        <button
          ...
          data-testid="pre-onboarding-folder-choice-continue"
        >
          Continue
        </button>
      </div>
...
function ChoiceCard({
  ...
  return (
    <button
      ...
      data-testid={`pre-onboarding-folder-choice-${choiceKey}`}
    >
