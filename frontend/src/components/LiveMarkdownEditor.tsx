            ...
            {currentBrokenImage.kind === "file" ? (
              ...
              <div className="py-4 text-center">
                ...
                <button
                  ...
                  className="ros-btn-raise mt-3 px-3 py-1.5 text-meta bg-red-500 hover:bg-red-600 text-white rounded transition-colors"
                >
              ...
              <div className="py-2">
                ...
                <div className="mt-3 flex flex-col gap-2">
                  <button
                    ...
                    className="ros-btn-raise w-full px-3 py-2 text-meta bg-brand-action hover:bg-brand-action/90 text-white rounded transition-colors flex items-center justify-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="ros-btn-raise w-full px-3 py-2 text-meta bg-green-600 hover:bg-green-700 disabled:bg-foreground-muted/20 disabled:cursor-not-allowed text-white rounded transition-colors flex items-center justify-center gap-1.5"
                  >
                    {isReplacingFromDisk ? (
                      <>
