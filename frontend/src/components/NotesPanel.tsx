    ...
    return (
      <div className="text-center py-12">
        ...
        <button
          ...
          className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 rounded-lg px-4 py-2"
        >
          Retry
        </button>
      </div>
            ...
            <div className="w-full rounded-xl bg-surface-raised shadow-xl">
              ...
              <div className="flex items-center justify-end gap-2 border-t border-border px-5 py-3">
                ...
                <button
                  ...
                  className="ros-btn-raise rounded-lg bg-red-600 px-4 py-2 text-body font-medium text-white transition-colors hover:bg-red-700"
                >
                  Delete notebook
                </button>
              </div>
        ...
        {!isLabMode && (
          <div className="relative new-note-dropdown">
            <button
              ...
              aria-label="New Note"
              className="ros-btn-raise bg-brand-action text-white transition-colors hover:bg-brand-action/90 rounded-lg px-4 py-2 flex items-center gap-2 text-body"
            >
