...
const DIFF_REMOVED_CLASSES =
  "bg-amber-50 ring-1 ring-amber-200 text-red-700 line-through whitespace-pre-wrap font-mono text-xs px-2 py-1 rounded";
const DIFF_ADDED_CLASSES =
  "bg-amber-50 ring-1 ring-amber-200 text-green-700 underline decoration-green-600 whitespace-pre-wrap font-mono text-xs px-2 py-1 rounded";
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        {isEditing ? (
          <textarea
            ...
            spellCheck={false}
            className="w-full min-h-[24rem] p-3 font-mono text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
