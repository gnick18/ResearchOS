      ...
      >
        ...
        <div className="p-6 space-y-4 overflow-y-auto flex-1">
          ...
          <div>
            ...
            <button
              ...
              className="w-full rounded-lg border-2 border-dashed border-border hover:border-sky-300 hover:bg-sky-50/40 dark:hover:bg-sky-500/15 transition-colors px-3 py-4 flex flex-col items-center gap-1.5 text-center"
            >
        ...
        <div className="p-4 border-t border-border bg-surface-sunken flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-2 text-body text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:hover:bg-gray-400"
          >
