/**
 * Minimal inline SVG icon set (Lucide-compatible paths, no external dependency).
 * All icons use currentColor, strokeWidth 2, 24x24 viewBox.
 */
...
const defaultClass = "w-3.5 h-3.5 inline-block shrink-0";
...
export function CameraIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
