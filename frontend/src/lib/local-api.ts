...
function normalizeTaskRecord(raw: Task): Task {
  ...
  if (filtered !== attachments || needsLcBackfill || needsCellCultureBackfill) {
    normalized = {
      ...normalized,
...
export const tasksApi = {
  ...
  create: async (data: {
    ...
    method_attachments?: Array<{ method_id: number; pcr_gradient?: string | null; pcr_ingredients?: string | null; lc_gradient?: string | null; cell_culture_schedule?: string | null; variation_notes?: string | null }>;
  }): Promise<Task> => {
