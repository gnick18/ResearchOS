...
- v1 applies one transform per call; a multi-step pipeline is coming in a later build. If the user describes a multi-step chain, tell them the pipeline builder is not yet available and offer to apply the transforms one at a time starting with the first one.
