 ...
 * partial pivoting, and also return the inverse of A (needed for the parameter
 * covariance). p is tiny (k+1), so an explicit O(p^3) solve is fine. Returns null
 * when A is singular (separation / collinearity).
 */
